									...
									<tbody>
										<foreach name="type" item="vo">
											<tr>
												...
												<td>
													<a href="__CONTROLLER__/giftadd/id/<?php echo $vo['id']; ?>">添加赠品</a>
												</td>

												<td>
													<a href="__CONTROLLER__/edit/id/<?php echo $vo['id']; ?>">修改</a>
													|
													<a href="__MODULE__/GoodsGallery/index/id/<?php echo $vo['id']; ?>">查看相册</a>
													|
													<a href="__MODULE__/Sale/index/id/<?php echo $vo['id']; ?>">秒杀</a>
													|
													<a href="__CONTROLLER__/recycle/id/<?php echo $vo['id']; ?>">删除</a>
												</td>
											</tr>
										</foreach>
										<tr>
